...
class Test(unittest.TestCase):
    ...
    def before_all(self):
        ...
        self.mongo.save('user', 'users', self.admin_user.to_dict())
        self.mongo.save('user', 'users', self.blacklist_user.to_dict())
        self.helper = AuthHelper(mongo_controller=self.mongo)
